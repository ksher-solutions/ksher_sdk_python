...
class KsherPay(object):
    ...
    def __init__(self, appid='', privatekey='', pubkey='./ksher_pubkey.pem', version='3.0.0'):
    ...
    def settlement_info(self, kwargs):
        ...
        response = self._request(url='{}/get_settlement_info'.format(self.__DOMAIN), data=kwargs, m="POST")
        return response
